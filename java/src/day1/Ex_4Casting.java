...
public class Ex_4Casting {
	public static void main(String[] args) {
		 ...
		 * 	-큰 타입의 값을 작은 타입에 저장하는 경우(자동타입 변환이 불가능한 경우)
		...
		int num4_1 = 1;
		double num4_2 = 1.23;
		//num4_1과 더하는 값이 실수이기 때문에 num4_1을 실수로 자동 타입변화를 한 후 실수 +실수를 계산하며 num4_3에 저장
		//더할 대 자동 타입변환함 
		double num4_3 = num4_1 +num4_2; 
		//num4_1과 더하는 값이 정수이기 때문에 정수 + 정수를 한 후 더한 값을 실수로 자동 타입변환 하여 num4_3에 저장
		...
		//55~56.정수를 실수로 자동타입변활할 때 정밀도가 떨어질 수 있다. int =>float
		//int => float으로 타입변환하기 보당 double로 타입변환하여 활용한다.
